...
func DrawTextureRec(texture Texture2D, sourceRec Rectangle, position Vector2, tint Color) {
	ctexture, _ := *(*C.Texture2D)(unsafe.Pointer(&texture)), cgoAllocsUnknown
	csourceRec, _ := *(*C.Rectangle)(unsafe.Pointer(&sourceRec)), cgoAllocsUnknown
	cposition, _ := *(*C.Vector2)(unsafe.Pointer(&position)), cgoAllocsUnknown
	ctint, _ := *(*C.Color)(unsafe.Pointer(&tint)), cgoAllocsUnknown
...
func DrawTextureTiled(texture Texture2D, sourceRec Rectangle, destRec Rectangle, origin Vector2, rotation float32, scale float32, tint Color) {
	ctexture, _ := *(*C.Texture2D)(unsafe.Pointer(&texture)), cgoAllocsUnknown
	csourceRec, _ := *(*C.Rectangle)(unsafe.Pointer(&sourceRec)), cgoAllocsUnknown
	cdestRec, _ := *(*C.Rectangle)(unsafe.Pointer(&destRec)), cgoAllocsUnknown
	corigin, _ := *(*C.Vector2)(unsafe.Pointer(&origin)), cgoAllocsUnknown
	crotation, _ := (C.float)(rotation), cgoAllocsUnknown
	cscale, _ := (C.float)(scale), cgoAllocsUnknown
	ctint, _ := *(*C.Color)(unsafe.Pointer(&tint)), cgoAllocsUnknown
...
func ColorFromHSV(hsv Vector3) Color {
	chsv, _ := *(*C.Vector3)(unsafe.Pointer(&hsv)), cgoAllocsUnknown
...
func CheckCollisionSpheres(centerA Vector3, radiusA float32, centerB Vector3, radiusB float32) bool {
	ccenterA, _ := *(*C.Vector3)(unsafe.Pointer(&centerA)), cgoAllocsUnknown
	cradiusA, _ := (C.float)(radiusA), cgoAllocsUnknown
	ccenterB, _ := *(*C.Vector3)(unsafe.Pointer(&centerB)), cgoAllocsUnknown
...
func GenTextureCubemap(shader Shader, _map Texture2D, size int32) Texture2D {
	cshader, _ := *(*C.Shader)(unsafe.Pointer(&shader)), cgoAllocsUnknown
	c_map, _ := *(*C.Texture2D)(unsafe.Pointer(&_map)), cgoAllocsUnknown
...
func GenTextureIrradiance(shader Shader, cubemap Texture2D, size int32) Texture2D {
	cshader, _ := *(*C.Shader)(unsafe.Pointer(&shader)), cgoAllocsUnknown
	ccubemap, _ := *(*C.Texture2D)(unsafe.Pointer(&cubemap)), cgoAllocsUnknown
	csize, _ := (C.int)(size), cgoAllocsUnknown
