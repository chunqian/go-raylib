...
func NewRenderTexture2D(cId uint32, cTexture Texture2D, cDepth Texture2D, cDepthTexture bool) RenderTexture2D {
	obj := *new(gRenderTexture2D)
	obj.gId = cId
	obj.gTexture = *newTexture2DRef(unsafe.Pointer(&cTexture))
	obj.gDepth = *newTexture2DRef(unsafe.Pointer(&cDepth))
	obj.gDepthTexture = cDepthTexture
...
func AllocRenderTexture2D(cId uint32, cTexture Texture2D, cDepth Texture2D, cDepthTexture bool) (*RenderTexture2D, *cgoAllocMap) {
	obj := *new(gRenderTexture2D)
	obj.gId = cId
	obj.gTexture = *newTexture2DRef(unsafe.Pointer(&cTexture))
	obj.gDepth = *newTexture2DRef(unsafe.Pointer(&cDepth))
...
func NewRenderTexture(cId uint32, cTexture Texture2D, cDepth Texture2D, cDepthTexture bool) RenderTexture {
	obj := *new(gRenderTexture)
	obj.gId = cId
	obj.gTexture = *newTexture2DRef(unsafe.Pointer(&cTexture))
	obj.gDepth = *newTexture2DRef(unsafe.Pointer(&cDepth))
...
func AllocRenderTexture(cId uint32, cTexture Texture2D, cDepth Texture2D, cDepthTexture bool) (*RenderTexture, *cgoAllocMap) {
	obj := *new(gRenderTexture)
	obj.gId = cId
	obj.gTexture = *newTexture2DRef(unsafe.Pointer(&cTexture))
	obj.gDepth = *newTexture2DRef(unsafe.Pointer(&cDepth))
...
func NewNPatchInfo(cSourceRec Rectangle, cLeft int32, cTop int32, cRight int32, cBottom int32, cType int32) NPatchInfo {
	obj := *new(gNPatchInfo)
	obj.gSourceRec = *newRectangleRef(unsafe.Pointer(&cSourceRec))
	obj.gLeft = cLeft
	obj.gTop = cTop
	obj.gRight = cRight
	obj.gBottom = cBottom
...
func AllocNPatchInfo(cSourceRec Rectangle, cLeft int32, cTop int32, cRight int32, cBottom int32, cType int32) (*NPatchInfo, *cgoAllocMap) {
	obj := *new(gNPatchInfo)
	obj.gSourceRec = *newRectangleRef(unsafe.Pointer(&cSourceRec))
	obj.gLeft = cLeft
	obj.gTop = cTop
...
func NewFont(cBaseSize int32, cCharsCount int32, cTexture Texture2D, cRecs []Rectangle, cChars []CharInfo) Font {
	obj := *new(gFont)
...
func AllocFont(cBaseSize int32, cCharsCount int32, cTexture Texture2D, cRecs []Rectangle, cChars []CharInfo) (*Font, *cgoAllocMap) {
	obj := *new(gFont)
	obj.gBaseSize = cBaseSize
	obj.gCharsCount = cCharsCount
	obj.gTexture = *newTexture2DRef(unsafe.Pointer(&cTexture))
...
func NewModel(cTransform Matrix, cMeshCount int32, cMeshes []Mesh, cMaterialCount int32, cMaterials []Material, cMeshMaterial []int32, cBoneCount int32, cBones []BoneInfo, cBindPose []Transform) Model {
	obj := *new(gModel)
...
func AllocModel(cTransform Matrix, cMeshCount int32, cMeshes []Mesh, cMaterialCount int32, cMaterials []Material, cMeshMaterial []int32, cBoneCount int32, cBones []BoneInfo, cBindPose []Transform) (*Model, *cgoAllocMap) {
	obj := *new(gModel)
	obj.gTransform = *newMatrixRef(unsafe.Pointer(&cTransform))
	obj.gMeshCount = cMeshCount
...
func NewModelAnimation(cBoneCount int32, cBones []BoneInfo, cFrameCount int32, cFramePoses [][]Transform) ModelAnimation {
	obj := *new(gModelAnimation)
	obj.gBoneCount = cBoneCount
...
func AllocModelAnimation(cBoneCount int32, cBones []BoneInfo, cFrameCount int32, cFramePoses [][]Transform) (*ModelAnimation, *cgoAllocMap) {
	obj := *new(gModelAnimation)
	obj.gBoneCount = cBoneCount
...
func NewSound(cSampleCount uint32, cStream AudioStream) Sound {
	obj := *new(gSound)
	obj.gSampleCount = cSampleCount
...
func AllocSound(cSampleCount uint32, cStream AudioStream) (*Sound, *cgoAllocMap) {
	obj := *new(gSound)
	obj.gSampleCount = cSampleCount
	obj.gStream = *newAudioStreamRef(unsafe.Pointer(&cStream))
...
func NewMusic(cCtxType int32, cCtxData unsafe.Pointer, cLooping bool, cSampleCount uint32, cStream AudioStream) Music {
	obj := *new(gMusic)
...
func AllocMusic(cCtxType int32, cCtxData unsafe.Pointer, cLooping bool, cSampleCount uint32, cStream AudioStream) (*Music, *cgoAllocMap) {
	obj := *new(gMusic)
	obj.gCtxType = cCtxType
	obj.gCtxData = cCtxData
	obj.gLooping = cLooping
