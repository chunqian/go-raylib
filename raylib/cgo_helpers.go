...
// Offset reads Go data structure out from plain C format.
func (x *Vector4) Offset(index int32) *Vector4 {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *Quaternion) Offset(index int32) *Quaternion {
	ptr0, _ := x.PassRef()
	ptr1 := (*C.Vector4)(unsafe.Pointer(uintptr(unsafe.Pointer(ptr0)) + uintptr(index)*uintptr(sizeOfVector4Value)))
...
// Offset reads Go data structure out from plain C format.
func (x *Matrix) Offset(index int32) *Matrix {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *Image) Offset(index int32) *Image {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *Texture) Offset(index int32) *Texture {
	ptr0, _ := x.PassRef()
	ptr1 := (*C.Texture2D)(unsafe.Pointer(uintptr(unsafe.Pointer(ptr0)) + uintptr(index)*uintptr(sizeOfTexture2DValue)))
...
// Offset reads Go data structure out from plain C format.
func (x *TextureCubemap) Offset(index int32) *TextureCubemap {
	ptr0, _ := x.PassRef()
	ptr1 := (*C.Texture2D)(unsafe.Pointer(uintptr(unsafe.Pointer(ptr0)) + uintptr(index)*uintptr(sizeOfTexture2DValue)))
...
// Offset reads Go data structure out from plain C format.
func (x *RenderTexture2D) Offset(index int32) *RenderTexture2D {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *RenderTexture) Offset(index int32) *RenderTexture {
	ptr0, _ := x.PassRef()
	ptr1 := (*C.RenderTexture2D)(unsafe.Pointer(uintptr(unsafe.Pointer(ptr0)) + uintptr(index)*uintptr(sizeOfRenderTexture2DValue)))
...
// Offset reads Go data structure out from plain C format.
func (x *NPatchInfo) Offset(index int32) *NPatchInfo {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *CharInfo) Offset(index int32) *CharInfo {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *Camera3D) Offset(index int32) *Camera3D {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *Camera) Offset(index int32) *Camera {
	ptr0, _ := x.PassRef()
	ptr1 := (*C.Camera3D)(unsafe.Pointer(uintptr(unsafe.Pointer(ptr0)) + uintptr(index)*uintptr(sizeOfCamera3DValue)))
...
// Offset reads Go data structure out from plain C format.
func (x *Camera2D) Offset(index int32) *Camera2D {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *Mesh) Offset(index int32) *Mesh {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *Shader) Offset(index int32) *Shader {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *MaterialMap) Offset(index int32) *MaterialMap {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *Material) Offset(index int32) *Material {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *Transform) Offset(index int32) *Transform {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *BoneInfo) Offset(index int32) *BoneInfo {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *Model) Offset(index int32) *Model {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *ModelAnimation) Offset(index int32) *ModelAnimation {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *Ray) Offset(index int32) *Ray {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *RayHitInfo) Offset(index int32) *RayHitInfo {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *BoundingBox) Offset(index int32) *BoundingBox {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *Wave) Offset(index int32) *Wave {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *AudioStream) Offset(index int32) *AudioStream {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *Sound) Offset(index int32) *Sound {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *Music) Offset(index int32) *Music {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *VrDeviceInfo) Offset(index int32) *VrDeviceInfo {
	ptr0, _ := x.PassRef()
...
// unpackArgSPRectangle transforms a sliced Go data structure into plain C format.
func unpackArgSPRectangle(x []*Rectangle) (unpacked **C.Rectangle, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
...
// packSPRectangle reads sliced Go data structure out from plain C format.
func packSPRectangle(v []*Rectangle, ptr0 **C.Rectangle) {
	const m = 0x7fffffff
	for i0 := range v {
