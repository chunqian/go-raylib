...
func NewVector2(x0 float32, y0 float32) Vector2 {
	obj := *new(gVector2)
	obj.gX = x0
	obj.gY = y0
...
func AllocVector2(x0 float32, y0 float32) (*Vector2, *cgoAllocMap) {
	obj := *new(gVector2)
	obj.gX = x0
	obj.gY = y0
...
func (x *Vector2) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
...
func NewVector3(x0 float32, y0 float32, z0 float32) Vector3 {
	obj := *new(gVector3)
	obj.gX = x0
	obj.gY = y0
	obj.gZ = z0
...
func AllocVector3(x0 float32, y0 float32, z0 float32) (*Vector3, *cgoAllocMap) {
	obj := *new(gVector3)
	obj.gX = x0
	obj.gY = y0
	obj.gZ = z0
...
// GC is register for garbage collection.
func (x *Vector3) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewVector4(x0 float32, y0 float32, z0 float32, w0 float32) Vector4 {
	obj := *new(gVector4)
	obj.gX = x0
	obj.gY = y0
	obj.gZ = z0
...
func AllocVector4(x0 float32, y0 float32, z0 float32, w0 float32) (*Vector4, *cgoAllocMap) {
	obj := *new(gVector4)
	obj.gX = x0
	obj.gY = y0
	obj.gZ = z0
...
// GC is register for garbage collection.
func (x *Vector4) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewQuaternion(x0 float32, y0 float32, z0 float32, w0 float32) Quaternion {
	obj := *new(gQuaternion)
	obj.gX = x0
	obj.gY = y0
	obj.gZ = z0
...
func AllocQuaternion(x0 float32, y0 float32, z0 float32, w0 float32) (*Quaternion, *cgoAllocMap) {
	obj := *new(gQuaternion)
	obj.gX = x0
	obj.gY = y0
	obj.gZ = z0
...
// GC is register for garbage collection.
func (x *Quaternion) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewMatrix(m00 float32, m40 float32, m80 float32, m120 float32, m10 float32, m50 float32, m90 float32, m130 float32, m20 float32, m60 float32, m100 float32, m140 float32, m30 float32, m70 float32, m110 float32, m150 float32) Matrix {
	obj := *new(gMatrix)
	obj.gM0 = m00
	obj.gM4 = m40
	obj.gM8 = m80
...
func AllocMatrix(m00 float32, m40 float32, m80 float32, m120 float32, m10 float32, m50 float32, m90 float32, m130 float32, m20 float32, m60 float32, m100 float32, m140 float32, m30 float32, m70 float32, m110 float32, m150 float32) (*Matrix, *cgoAllocMap) {
	obj := *new(gMatrix)
	obj.gM0 = m00
	obj.gM4 = m40
	obj.gM8 = m80
...
// GC is register for garbage collection.
func (x *Matrix) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewColor(r0 byte, g0 byte, b0 byte, a0 byte) Color {
	obj := *new(gColor)
	obj.gR = r0
	obj.gG = g0
	obj.gB = b0
...
func AllocColor(r0 byte, g0 byte, b0 byte, a0 byte) (*Color, *cgoAllocMap) {
	obj := *new(gColor)
	obj.gR = r0
	obj.gG = g0
	obj.gB = b0
...
func NewRectangle(x0 float32, y0 float32, width0 float32, height0 float32) Rectangle {
	obj := *new(gRectangle)
	obj.gX = x0
	obj.gY = y0
	obj.gWidth = width0
...
func AllocRectangle(x0 float32, y0 float32, width0 float32, height0 float32) (*Rectangle, *cgoAllocMap) {
	obj := *new(gRectangle)
	obj.gX = x0
	obj.gY = y0
	obj.gWidth = width0
...
// GC is register for garbage collection.
func (x *Rectangle) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewImage(data0 unsafe.Pointer, width0 int32, height0 int32, mipmaps0 int32, format0 int32) Image {
	obj := *new(gImage)
	obj.gData = data0
	obj.gWidth = width0
	obj.gHeight = height0
	obj.gMipmaps = mipmaps0
	obj.gFormat = format0
...
func AllocImage(data0 unsafe.Pointer, width0 int32, height0 int32, mipmaps0 int32, format0 int32) (*Image, *cgoAllocMap) {
	obj := *new(gImage)
	obj.gData = data0
	obj.gWidth = width0
	obj.gHeight = height0
...
func NewTexture2D(id0 uint32, width0 int32, height0 int32, mipmaps0 int32, format0 int32) Texture2D {
	obj := *new(gTexture2D)
	obj.gId = id0
	obj.gWidth = width0
	obj.gHeight = height0
...
func AllocTexture2D(id0 uint32, width0 int32, height0 int32, mipmaps0 int32, format0 int32) (*Texture2D, *cgoAllocMap) {
	obj := *new(gTexture2D)
	obj.gId = id0
	obj.gWidth = width0
	obj.gHeight = height0
...
// GC is register for garbage collection.
func (x *Texture2D) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewTexture(id0 uint32, width0 int32, height0 int32, mipmaps0 int32, format0 int32) Texture {
	obj := *new(gTexture)
	obj.gId = id0
	obj.gWidth = width0
	obj.gHeight = height0
...
func AllocTexture(id0 uint32, width0 int32, height0 int32, mipmaps0 int32, format0 int32) (*Texture, *cgoAllocMap) {
	obj := *new(gTexture)
	obj.gId = id0
	obj.gWidth = width0
	obj.gHeight = height0
...
// GC is register for garbage collection.
func (x *Texture) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewTextureCubemap(id0 uint32, width0 int32, height0 int32, mipmaps0 int32, format0 int32) TextureCubemap {
	obj := *new(gTextureCubemap)
	obj.gId = id0
	obj.gWidth = width0
	obj.gHeight = height0
...
func AllocTextureCubemap(id0 uint32, width0 int32, height0 int32, mipmaps0 int32, format0 int32) (*TextureCubemap, *cgoAllocMap) {
	obj := *new(gTextureCubemap)
	obj.gId = id0
	obj.gWidth = width0
	obj.gHeight = height0
...
// GC is register for garbage collection.
func (x *TextureCubemap) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewRenderTexture2D(id0 uint32, texture0 Texture2D, depth0 Texture2D, depthTexture0 bool) RenderTexture2D {
	obj := *new(gRenderTexture2D)
	obj.gId = id0
	obj.gTexture = *newTexture2DRef(unsafe.Pointer(&texture0))
	obj.gDepth = *newTexture2DRef(unsafe.Pointer(&depth0))
	obj.gDepthTexture = depthTexture0
...
func AllocRenderTexture2D(id0 uint32, texture0 Texture2D, depth0 Texture2D, depthTexture0 bool) (*RenderTexture2D, *cgoAllocMap) {
	obj := *new(gRenderTexture2D)
	obj.gId = id0
	obj.gTexture = *newTexture2DRef(unsafe.Pointer(&texture0))
	obj.gDepth = *newTexture2DRef(unsafe.Pointer(&depth0))
...
// GC is register for garbage collection.
func (x *RenderTexture2D) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewRenderTexture(id0 uint32, texture0 Texture2D, depth0 Texture2D, depthTexture0 bool) RenderTexture {
	obj := *new(gRenderTexture)
	obj.gId = id0
	obj.gTexture = *newTexture2DRef(unsafe.Pointer(&texture0))
	obj.gDepth = *newTexture2DRef(unsafe.Pointer(&depth0))
...
func AllocRenderTexture(id0 uint32, texture0 Texture2D, depth0 Texture2D, depthTexture0 bool) (*RenderTexture, *cgoAllocMap) {
	obj := *new(gRenderTexture)
	obj.gId = id0
	obj.gTexture = *newTexture2DRef(unsafe.Pointer(&texture0))
	obj.gDepth = *newTexture2DRef(unsafe.Pointer(&depth0))
...
// GC is register for garbage collection.
func (x *RenderTexture) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewNPatchInfo(sourceRec0 Rectangle, left0 int32, top0 int32, right0 int32, bottom0 int32, type0 int32) NPatchInfo {
	obj := *new(gNPatchInfo)
	obj.gSourceRec = *newRectangleRef(unsafe.Pointer(&sourceRec0))
	obj.gLeft = left0
	obj.gTop = top0
	obj.gRight = right0
	obj.gBottom = bottom0
...
func AllocNPatchInfo(sourceRec0 Rectangle, left0 int32, top0 int32, right0 int32, bottom0 int32, type0 int32) (*NPatchInfo, *cgoAllocMap) {
	obj := *new(gNPatchInfo)
	obj.gSourceRec = *newRectangleRef(unsafe.Pointer(&sourceRec0))
	obj.gLeft = left0
	obj.gTop = top0
...
// GC is register for garbage collection.
func (x *NPatchInfo) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewCharInfo(value0 int32, offsetX0 int32, offsetY0 int32, advanceX0 int32, image0 Image) CharInfo {
	obj := *new(gCharInfo)
	obj.gValue = value0
	obj.gOffsetX = offsetX0
	obj.gOffsetY = offsetY0
	obj.gAdvanceX = advanceX0
	obj.gImage = *newImageRef(unsafe.Pointer(&image0))
...
func AllocCharInfo(value0 int32, offsetX0 int32, offsetY0 int32, advanceX0 int32, image0 Image) (*CharInfo, *cgoAllocMap) {
	obj := *new(gCharInfo)
	obj.gValue = value0
	obj.gOffsetX = offsetX0
	obj.gOffsetY = offsetY0
...
// GC is register for garbage collection.
func (x *CharInfo) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewFont(baseSize0 int32, charsCount0 int32, texture0 Texture2D, recs0 []Rectangle, chars0 []CharInfo) Font {
	obj := *new(gFont)
	obj.gBaseSize = baseSize0
	obj.gCharsCount = charsCount0
	obj.gTexture = *newTexture2DRef(unsafe.Pointer(&texture0))

	var recs1 []gRectangle
	for i0 := range recs0 {
		p0 := *newRectangleRef(unsafe.Pointer(&recs0[i0]))
		recs1 = append(recs1, p0)
	}
	obj.gRecs = recs1

	var chars1 []gCharInfo
	for i0 := range chars0 {
		p0 := *newCharInfoRef(unsafe.Pointer(&chars0[i0]))
		chars1 = append(chars1, p0)
	}
	obj.gChars = chars1
...
func AllocFont(baseSize0 int32, charsCount0 int32, texture0 Texture2D, recs0 []Rectangle, chars0 []CharInfo) (*Font, *cgoAllocMap) {
	obj := *new(gFont)
	obj.gBaseSize = baseSize0
	obj.gCharsCount = charsCount0
	obj.gTexture = *newTexture2DRef(unsafe.Pointer(&texture0))
...
func NewCamera3D(position0 Vector3, target0 Vector3, up0 Vector3, fovy0 float32, type0 int32) Camera3D {
	obj := *new(gCamera3D)
	obj.gPosition = *newVector3Ref(unsafe.Pointer(&position0))
	obj.gTarget = *newVector3Ref(unsafe.Pointer(&target0))
	obj.gUp = *newVector3Ref(unsafe.Pointer(&up0))
	obj.gFovy = fovy0
	obj.gType = type0
...
func AllocCamera3D(position0 Vector3, target0 Vector3, up0 Vector3, fovy0 float32, type0 int32) (*Camera3D, *cgoAllocMap) {
	obj := *new(gCamera3D)
	obj.gPosition = *newVector3Ref(unsafe.Pointer(&position0))
	obj.gTarget = *newVector3Ref(unsafe.Pointer(&target0))
	obj.gUp = *newVector3Ref(unsafe.Pointer(&up0))
...
// GC is register for garbage collection.
func (x *Camera3D) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewCamera(position0 Vector3, target0 Vector3, up0 Vector3, fovy0 float32, type0 int32) Camera {
	obj := *new(gCamera)
	obj.gPosition = *newVector3Ref(unsafe.Pointer(&position0))
	obj.gTarget = *newVector3Ref(unsafe.Pointer(&target0))
	obj.gUp = *newVector3Ref(unsafe.Pointer(&up0))
...
func AllocCamera(position0 Vector3, target0 Vector3, up0 Vector3, fovy0 float32, type0 int32) (*Camera, *cgoAllocMap) {
	obj := *new(gCamera)
	obj.gPosition = *newVector3Ref(unsafe.Pointer(&position0))
	obj.gTarget = *newVector3Ref(unsafe.Pointer(&target0))
	obj.gUp = *newVector3Ref(unsafe.Pointer(&up0))
...
// GC is register for garbage collection.
func (x *Camera) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewCamera2D(offset0 Vector2, target0 Vector2, rotation0 float32, zoom0 float32) Camera2D {
	obj := *new(gCamera2D)
	obj.gOffset = *newVector2Ref(unsafe.Pointer(&offset0))
	obj.gTarget = *newVector2Ref(unsafe.Pointer(&target0))
	obj.gRotation = rotation0
	obj.gZoom = zoom0
...
func AllocCamera2D(offset0 Vector2, target0 Vector2, rotation0 float32, zoom0 float32) (*Camera2D, *cgoAllocMap) {
	obj := *new(gCamera2D)
	obj.gOffset = *newVector2Ref(unsafe.Pointer(&offset0))
	obj.gTarget = *newVector2Ref(unsafe.Pointer(&target0))
	obj.gRotation = rotation0
...
// GC is register for garbage collection.
func (x *Camera2D) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewMesh(vertexCount0 int32, triangleCount0 int32, vertices0 []float32, texcoords0 []float32, texcoords20 []float32, normals0 []float32, tangents0 []float32, colors0 []byte, indices0 []uint16, animVertices0 []float32, animNormals0 []float32, boneIds0 []int32, boneWeights0 []float32, vaoId0 uint32, vboId0 []uint32) Mesh {
	obj := *new(gMesh)
	obj.gVertexCount = vertexCount0
	obj.gTriangleCount = triangleCount0
	obj.gVertices = vertices0
	obj.gTexcoords = texcoords0
	obj.gTexcoords2 = texcoords20
	obj.gNormals = normals0
	obj.gTangents = tangents0
	obj.gColors = colors0
	obj.gIndices = indices0
	obj.gAnimVertices = animVertices0
	obj.gAnimNormals = animNormals0
	obj.gBoneIds = boneIds0
	obj.gBoneWeights = boneWeights0
	obj.gVaoId = vaoId0
	obj.gVboId = vboId0
...
func AllocMesh(vertexCount0 int32, triangleCount0 int32, vertices0 []float32, texcoords0 []float32, texcoords20 []float32, normals0 []float32, tangents0 []float32, colors0 []byte, indices0 []uint16, animVertices0 []float32, animNormals0 []float32, boneIds0 []int32, boneWeights0 []float32, vaoId0 uint32, vboId0 []uint32) (*Mesh, *cgoAllocMap) {
	obj := *new(gMesh)
	obj.gVertexCount = vertexCount0
	obj.gTriangleCount = triangleCount0
	obj.gVertices = vertices0
...
func NewShader(id0 uint32, locs0 []int32) Shader {
	obj := *new(gShader)
	obj.gId = id0
	obj.gLocs = locs0
...
func AllocShader(id0 uint32, locs0 []int32) (*Shader, *cgoAllocMap) {
	obj := *new(gShader)
	obj.gId = id0
	obj.gLocs = locs0
...
// GC is register for garbage collection.
func (x *Shader) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewMaterialMap(texture0 Texture2D, color0 Color, value0 float32) MaterialMap {
	obj := *new(gMaterialMap)
	obj.gTexture = *newTexture2DRef(unsafe.Pointer(&texture0))
	obj.gColor = *newColorRef(unsafe.Pointer(&color0))
	obj.gValue = value0
...
func AllocMaterialMap(texture0 Texture2D, color0 Color, value0 float32) (*MaterialMap, *cgoAllocMap) {
	obj := *new(gMaterialMap)
	obj.gTexture = *newTexture2DRef(unsafe.Pointer(&texture0))
	obj.gColor = *newColorRef(unsafe.Pointer(&color0))
	obj.gValue = value0
...
// GC is register for garbage collection.
func (x *MaterialMap) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewMaterial(shader0 Shader, maps0 []MaterialMap, params0 []float32) Material {
	obj := *new(gMaterial)
	obj.gShader = *newShaderRef(unsafe.Pointer(&shader0))

	var maps1 []gMaterialMap
	for i0 := range maps0 {
		p0 := *newMaterialMapRef(unsafe.Pointer(&maps0[i0]))
		maps1 = append(maps1, p0)
	}
	obj.gMaps = maps1
	obj.gParams = params0
...
func AllocMaterial(shader0 Shader, maps0 []MaterialMap, params0 []float32) (*Material, *cgoAllocMap) {
	obj := *new(gMaterial)
	obj.gShader = *newShaderRef(unsafe.Pointer(&shader0))
...
// GC is register for garbage collection.
func (x *Material) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewTransform(translation0 Vector3, rotation0 Quaternion, scale0 Vector3) Transform {
	obj := *new(gTransform)
	obj.gTranslation = *newVector3Ref(unsafe.Pointer(&translation0))
	obj.gRotation = *newQuaternionRef(unsafe.Pointer(&rotation0))
	obj.gScale = *newVector3Ref(unsafe.Pointer(&scale0))
...
func AllocTransform(translation0 Vector3, rotation0 Quaternion, scale0 Vector3) (*Transform, *cgoAllocMap) {
	obj := *new(gTransform)
	obj.gTranslation = *newVector3Ref(unsafe.Pointer(&translation0))
	obj.gRotation = *newQuaternionRef(unsafe.Pointer(&rotation0))
	obj.gScale = *newVector3Ref(unsafe.Pointer(&scale0))
...
// GC is register for garbage collection.
func (x *Transform) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewBoneInfo(name0 [32]byte, parent0 int32) BoneInfo {
	obj := *new(gBoneInfo)
	obj.gName = name0
	obj.gParent = parent0
...
func AllocBoneInfo(name0 [32]byte, parent0 int32) (*BoneInfo, *cgoAllocMap) {
	obj := *new(gBoneInfo)
	obj.gName = name0
	obj.gParent = parent0
...
// GC is register for garbage collection.
func (x *BoneInfo) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewModel(transform0 Matrix, meshCount0 int32, meshes0 []Mesh, materialCount0 int32, materials0 []Material, meshMaterial0 []int32, boneCount0 int32, bones0 []BoneInfo, bindPose0 []Transform) Model {
	obj := *new(gModel)
	obj.gTransform = *newMatrixRef(unsafe.Pointer(&transform0))
	obj.gMeshCount = meshCount0

	var meshes1 []gMesh
	for i0 := range meshes0 {
		p0 := *newMeshRef(unsafe.Pointer(&meshes0[i0]))
		meshes1 = append(meshes1, p0)
	}
	obj.gMeshes = meshes1
	obj.gMaterialCount = materialCount0

	var materials1 []gMaterial
	for i0 := range materials0 {
		p0 := *newMaterialRef(unsafe.Pointer(&materials0[i0]))
		materials1 = append(materials1, p0)
	}
	obj.gMaterials = materials1
	obj.gMeshMaterial = meshMaterial0
	obj.gBoneCount = boneCount0

	var bones1 []gBoneInfo
	for i0 := range bones0 {
		p0 := *newBoneInfoRef(unsafe.Pointer(&bones0[i0]))
		bones1 = append(bones1, p0)
	}
	obj.gBones = bones1

	var bindPose1 []gTransform
	for i0 := range bindPose0 {
		p0 := *newTransformRef(unsafe.Pointer(&bindPose0[i0]))
		bindPose1 = append(bindPose1, p0)
	}
	obj.gBindPose = bindPose1
...
func AllocModel(transform0 Matrix, meshCount0 int32, meshes0 []Mesh, materialCount0 int32, materials0 []Material, meshMaterial0 []int32, boneCount0 int32, bones0 []BoneInfo, bindPose0 []Transform) (*Model, *cgoAllocMap) {
	obj := *new(gModel)
	obj.gTransform = *newMatrixRef(unsafe.Pointer(&transform0))
	obj.gMeshCount = meshCount0
...
func NewModelAnimation(boneCount0 int32, bones0 []BoneInfo, frameCount0 int32, framePoses0 [][]Transform) ModelAnimation {
	obj := *new(gModelAnimation)
	obj.gBoneCount = boneCount0
	...
	obj.gBones = bones1
	obj.gFrameCount = frameCount0

	var framePoses1 [][]gTransform
	for i0, v0 := range framePoses0 {
		s0 := make([]gTransform, len(v0))
		for i1 := range v0 {
			p0 := *newTransformRef(unsafe.Pointer(&framePoses0[i0][i1]))
			s0 = append(s0, p0)
		}
		framePoses1 = append(framePoses1, s0)
	}
	obj.gFramePoses = framePoses1
...
func AllocModelAnimation(boneCount0 int32, bones0 []BoneInfo, frameCount0 int32, framePoses0 [][]Transform) (*ModelAnimation, *cgoAllocMap) {
	obj := *new(gModelAnimation)
	obj.gBoneCount = boneCount0
...
// GC is register for garbage collection.
func (x *ModelAnimation) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewRay(position0 Vector3, direction0 Vector3) Ray {
	obj := *new(gRay)
	obj.gPosition = *newVector3Ref(unsafe.Pointer(&position0))
	obj.gDirection = *newVector3Ref(unsafe.Pointer(&direction0))
...
func AllocRay(position0 Vector3, direction0 Vector3) (*Ray, *cgoAllocMap) {
	obj := *new(gRay)
	obj.gPosition = *newVector3Ref(unsafe.Pointer(&position0))
	obj.gDirection = *newVector3Ref(unsafe.Pointer(&direction0))
...
func NewRayHitInfo(hit0 bool, distance0 float32, position0 Vector3, normal0 Vector3) RayHitInfo {
	obj := *new(gRayHitInfo)
	obj.gHit = hit0
	obj.gDistance = distance0
	obj.gPosition = *newVector3Ref(unsafe.Pointer(&position0))
	obj.gNormal = *newVector3Ref(unsafe.Pointer(&normal0))
...
func AllocRayHitInfo(hit0 bool, distance0 float32, position0 Vector3, normal0 Vector3) (*RayHitInfo, *cgoAllocMap) {
	obj := *new(gRayHitInfo)
	obj.gHit = hit0
	obj.gDistance = distance0
	obj.gPosition = *newVector3Ref(unsafe.Pointer(&position0))
...
// GC is register for garbage collection.
func (x *RayHitInfo) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewBoundingBox(min0 Vector3, max0 Vector3) BoundingBox {
	obj := *new(gBoundingBox)
	obj.gMin = *newVector3Ref(unsafe.Pointer(&min0))
	obj.gMax = *newVector3Ref(unsafe.Pointer(&max0))
...
func AllocBoundingBox(min0 Vector3, max0 Vector3) (*BoundingBox, *cgoAllocMap) {
	obj := *new(gBoundingBox)
	obj.gMin = *newVector3Ref(unsafe.Pointer(&min0))
	obj.gMax = *newVector3Ref(unsafe.Pointer(&max0))
...
// GC is register for garbage collection.
func (x *BoundingBox) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewWave(sampleCount0 uint32, sampleRate0 uint32, sampleSize0 uint32, channels0 uint32, data0 unsafe.Pointer) Wave {
	obj := *new(gWave)
	obj.gSampleCount = sampleCount0
	obj.gSampleRate = sampleRate0
	obj.gSampleSize = sampleSize0
	obj.gChannels = channels0
	obj.gData = data0
...
func AllocWave(sampleCount0 uint32, sampleRate0 uint32, sampleSize0 uint32, channels0 uint32, data0 unsafe.Pointer) (*Wave, *cgoAllocMap) {
	obj := *new(gWave)
	obj.gSampleCount = sampleCount0
	obj.gSampleRate = sampleRate0
	obj.gSampleSize = sampleSize0
...
func NewAudioStream(sampleRate0 uint32, sampleSize0 uint32, channels0 uint32) AudioStream {
	obj := *new(gAudioStream)
	obj.gSampleRate = sampleRate0
	obj.gSampleSize = sampleSize0
	obj.gChannels = channels0
...
func AllocAudioStream(sampleRate0 uint32, sampleSize0 uint32, channels0 uint32) (*AudioStream, *cgoAllocMap) {
	obj := *new(gAudioStream)
	obj.gSampleRate = sampleRate0
	obj.gSampleSize = sampleSize0
	obj.gChannels = channels0
...
// GC is register for garbage collection.
func (x *AudioStream) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewSound(sampleCount0 uint32, stream0 AudioStream) Sound {
	obj := *new(gSound)
	obj.gSampleCount = sampleCount0
	obj.gStream = *newAudioStreamRef(unsafe.Pointer(&stream0))
...
func AllocSound(sampleCount0 uint32, stream0 AudioStream) (*Sound, *cgoAllocMap) {
	obj := *new(gSound)
	obj.gSampleCount = sampleCount0
	obj.gStream = *newAudioStreamRef(unsafe.Pointer(&stream0))
...
func NewMusic(ctxType0 int32, ctxData0 unsafe.Pointer, looping0 bool, sampleCount0 uint32, stream0 AudioStream) Music {
	obj := *new(gMusic)
	obj.gCtxType = ctxType0
	obj.gCtxData = ctxData0
	obj.gLooping = looping0
	obj.gSampleCount = sampleCount0
	obj.gStream = *newAudioStreamRef(unsafe.Pointer(&stream0))
...
func AllocMusic(ctxType0 int32, ctxData0 unsafe.Pointer, looping0 bool, sampleCount0 uint32, stream0 AudioStream) (*Music, *cgoAllocMap) {
	obj := *new(gMusic)
	obj.gCtxType = ctxType0
	obj.gCtxData = ctxData0
	obj.gLooping = looping0
...
func NewVrDeviceInfo(hResolution0 int32, vResolution0 int32, hScreenSize0 float32, vScreenSize0 float32, vScreenCenter0 float32, eyeToScreenDistance0 float32, lensSeparationDistance0 float32, interpupillaryDistance0 float32, lensDistortionValues0 [4]float32, chromaAbCorrection0 [4]float32) VrDeviceInfo {
	obj := *new(gVrDeviceInfo)
	obj.gHResolution = hResolution0
	obj.gVResolution = vResolution0
	obj.gHScreenSize = hScreenSize0
	obj.gVScreenSize = vScreenSize0
	obj.gVScreenCenter = vScreenCenter0
	obj.gEyeToScreenDistance = eyeToScreenDistance0
	obj.gLensSeparationDistance = lensSeparationDistance0
	obj.gInterpupillaryDistance = interpupillaryDistance0
	obj.gLensDistortionValues = lensDistortionValues0
	obj.gChromaAbCorrection = chromaAbCorrection0
...
func AllocVrDeviceInfo(hResolution0 int32, vResolution0 int32, hScreenSize0 float32, vScreenSize0 float32, vScreenCenter0 float32, eyeToScreenDistance0 float32, lensSeparationDistance0 float32, interpupillaryDistance0 float32, lensDistortionValues0 [4]float32, chromaAbCorrection0 [4]float32) (*VrDeviceInfo, *cgoAllocMap) {
	obj := *new(gVrDeviceInfo)
	obj.gHResolution = hResolution0
	obj.gVResolution = vResolution0
	obj.gHScreenSize = hScreenSize0
...
// GC is register for garbage collection.
func (x *VrDeviceInfo) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewMultiText(text0 []string) MultiText {
	obj := *new(gMultiText)
	obj.gText = text0
...
func AllocMultiText(text0 []string) (*MultiText, *cgoAllocMap) {
	obj := *new(gMultiText)
	obj.gText = text0
...
// GC is register for garbage collection.
func (x *MultiText) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
