...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gQuaternion) ref() *C.Vector4 {
	if x == nil {
		return nil
	}
	return x.refc0a9c490
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gRectangle) ref() *C.Rectangle {
	if x == nil {
		return nil
	}
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gTexture2D) ref() *C.Texture2D {
	if x == nil {
		return nil
	}
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gTexture) ref() *C.Texture2D {
	if x == nil {
		return nil
	}
	return x.ref3c51a40b
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gTextureCubemap) ref() *C.Texture2D {
	if x == nil {
		return nil
	}
	return x.ref3c51a40b
...
func NewRenderTexture2D(gId uint32, gTexture Texture2D, gDepth Texture2D, gDepthTexture bool) RenderTexture2D {
	...
	obj.gId = gId
	obj.gTexture = *newTexture2DRef(unsafe.Pointer(&gTexture))
	obj.gDepth = *newTexture2DRef(unsafe.Pointer(&gDepth))
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gRenderTexture2D) ref() *C.RenderTexture2D {
	if x == nil {
		return nil
	}
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gRenderTexture) ref() *C.RenderTexture2D {
	if x == nil {
		return nil
	}
	return x.ref2f94e9e3
...
func NewNPatchInfo(gSourceRec Rectangle, gLeft int32, gTop int32, gRight int32, gBottom int32, gType int32) NPatchInfo {
	obj := *new(gNPatchInfo)
	obj.gSourceRec = *newRectangleRef(unsafe.Pointer(&gSourceRec))
	obj.gLeft = gLeft
	obj.gTop = gTop
	obj.gRight = gRight
	obj.gBottom = gBottom
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gNPatchInfo) ref() *C.NPatchInfo {
	if x == nil {
		return nil
	}
...
func NewCharInfo(gValue int32, gOffsetX int32, gOffsetY int32, gAdvanceX int32, gImage Image) CharInfo {
	...
	obj.gImage = *newImageRef(unsafe.Pointer(&gImage))
	ret := obj.convert()
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gCharInfo) ref() *C.CharInfo {
	if x == nil {
		return nil
	}
...
func NewFont(gBaseSize int32, gCharsCount int32, gTexture Texture2D, gRecs []gRectangle, gChars []gCharInfo) Font {
	obj := *new(gFont)
...
func NewCamera3D(gPosition Vector3, gTarget Vector3, gUp Vector3, gFovy float32, gType int32) Camera3D {
	obj := *new(gCamera3D)
	obj.gPosition = *newVector3Ref(unsafe.Pointer(&gPosition))
	obj.gTarget = *newVector3Ref(unsafe.Pointer(&gTarget))
	obj.gUp = *newVector3Ref(unsafe.Pointer(&gUp))
	obj.gFovy = gFovy
	obj.gType = gType
	ret := obj.convert()
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gCamera3D) ref() *C.Camera3D {
	if x == nil {
		return nil
	}
	return x.ref7b09036
...
func NewCamera2D(gOffset Vector2, gTarget Vector2, gRotation float32, gZoom float32) Camera2D {
	obj := *new(gCamera2D)
	obj.gOffset = *newVector2Ref(unsafe.Pointer(&gOffset))
	obj.gTarget = *newVector2Ref(unsafe.Pointer(&gTarget))
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gCamera2D) ref() *C.Camera2D {
	if x == nil {
		return nil
	}
...
func NewMaterialMap(gTexture Texture2D, gColor Color, gValue float32) MaterialMap {
	...
	obj.gTexture = *newTexture2DRef(unsafe.Pointer(&gTexture))
	obj.gColor = *newColorRef(unsafe.Pointer(&gColor))
	obj.gValue = gValue
	ret := obj.convert()
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gMaterialMap) ref() *C.MaterialMap {
	if x == nil {
		return nil
	}
...
func NewMaterial(gShader Shader, gMaps []gMaterialMap, gParams []float32) Material {
	obj := *new(gMaterial)
	obj.gShader = *newShaderRef(unsafe.Pointer(&gShader))
	obj.gMaps = gMaps
	obj.gParams = gParams
	ret := obj.convert()
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gMaterial) ref() *C.Material {
	if x == nil {
		return nil
	}
...
func NewTransform(gTranslation Vector3, gRotation Quaternion, gScale Vector3) Transform {
	obj := *new(gTransform)
	obj.gTranslation = *newVector3Ref(unsafe.Pointer(&gTranslation))
	obj.gRotation = *newQuaternionRef(unsafe.Pointer(&gRotation))
	obj.gScale = *newVector3Ref(unsafe.Pointer(&gScale))
	ret := obj.convert()
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gTransform) ref() *C.Transform {
	if x == nil {
		return nil
	}
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gBoneInfo) ref() *C.BoneInfo {
	if x == nil {
		return nil
	}
...
func NewModel(gTransform Matrix, gMeshCount int32, gMeshes []gMesh, gMaterialCount int32, gMaterials []gMaterial, gMeshMaterial []int32, gBoneCount int32, gBones []gBoneInfo, gBindPose []gTransform) Model {
	obj := *new(gModel)
	obj.gTransform = *newMatrixRef(unsafe.Pointer(&gTransform))
...
func NewModelAnimation(gBoneCount int32, gBones []gBoneInfo, gFrameCount int32, gFramePoses [][]gTransform) ModelAnimation {
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gModelAnimation) ref() *C.ModelAnimation {
	if x == nil {
		return nil
	}
...
func NewRay(gPosition Vector3, gDirection Vector3) Ray {
	obj := *new(gRay)
	obj.gPosition = *newVector3Ref(unsafe.Pointer(&gPosition))
	obj.gDirection = *newVector3Ref(unsafe.Pointer(&gDirection))
	ret := obj.convert()
...
func NewRayHitInfo(gHit bool, gDistance float32, gPosition Vector3, gNormal Vector3) RayHitInfo {
	...
	obj.gPosition = *newVector3Ref(unsafe.Pointer(&gPosition))
	obj.gNormal = *newVector3Ref(unsafe.Pointer(&gNormal))
	ret := obj.convert()
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gRayHitInfo) ref() *C.RayHitInfo {
	if x == nil {
		return nil
	}
...
func NewBoundingBox(gMin Vector3, gMax Vector3) BoundingBox {
	...
	obj.gMin = *newVector3Ref(unsafe.Pointer(&gMin))
	obj.gMax = *newVector3Ref(unsafe.Pointer(&gMax))
	ret := obj.convert()
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gBoundingBox) ref() *C.BoundingBox {
	if x == nil {
		return nil
	}
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gAudioStream) ref() *C.AudioStream {
	if x == nil {
		return nil
	}
...
func NewSound(gSampleCount uint32, gStream AudioStream) Sound {
	obj := *new(gSound)
	obj.gSampleCount = gSampleCount
	obj.gStream = *newAudioStreamRef(unsafe.Pointer(&gStream))
	ret := obj.convert()
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gVrDeviceInfo) ref() *C.VrDeviceInfo {
	if x == nil {
		return nil
	}
...
func NewMultiText(gText []string) MultiText {
	obj := *new(gMultiText)
	obj.gText = gText
	ret := obj.convert()
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gMultiText) ref() *C.MultiText {
	if x == nil {
		return nil
	}
	return x.refdf1ec495
}
