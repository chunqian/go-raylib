...
func AllocVector2(vX float32, vY float32) (*Vector2, *cgoAllocMap) {
	obj := *new(gVector2)
	obj.gX = vX
	obj.gY = vY
...
func AllocVector3(vX float32, vY float32, vZ float32) (*Vector3, *cgoAllocMap) {
	obj := *new(gVector3)
	obj.gX = vX
	obj.gY = vY
	obj.gZ = vZ
...
func AllocVector4(vX float32, vY float32, vZ float32, vW float32) (*Vector4, *cgoAllocMap) {
	obj := *new(gVector4)
	obj.gX = vX
	obj.gY = vY
	obj.gZ = vZ
...
func AllocQuaternion(vX float32, vY float32, vZ float32, vW float32) (*Quaternion, *cgoAllocMap) {
	obj := *new(gQuaternion)
	obj.gX = vX
	obj.gY = vY
	obj.gZ = vZ
...
func AllocMatrix(vM0 float32, vM4 float32, vM8 float32, vM12 float32, vM1 float32, vM5 float32, vM9 float32, vM13 float32, vM2 float32, vM6 float32, vM10 float32, vM14 float32, vM3 float32, vM7 float32, vM11 float32, vM15 float32) (*Matrix, *cgoAllocMap) {
	obj := *new(gMatrix)
	obj.gM0 = vM0
	obj.gM4 = vM4
	obj.gM8 = vM8
...
func AllocColor(vR byte, vG byte, vB byte, vA byte) (*Color, *cgoAllocMap) {
	obj := *new(gColor)
	obj.gR = vR
	obj.gG = vG
	obj.gB = vB
...
func AllocRectangle(vX float32, vY float32, vWidth float32, vHeight float32) (*Rectangle, *cgoAllocMap) {
	obj := *new(gRectangle)
	obj.gX = vX
	obj.gY = vY
	obj.gWidth = vWidth
...
func AllocImage(vData unsafe.Pointer, vWidth int32, vHeight int32, vMipmaps int32, vFormat int32) (*Image, *cgoAllocMap) {
	obj := *new(gImage)
	obj.gData = vData
	obj.gWidth = vWidth
	obj.gHeight = vHeight
...
func AllocTexture2D(vId uint32, vWidth int32, vHeight int32, vMipmaps int32, vFormat int32) (*Texture2D, *cgoAllocMap) {
	obj := *new(gTexture2D)
	obj.gId = vId
	obj.gWidth = vWidth
	obj.gHeight = vHeight
...
func AllocTexture(vId uint32, vWidth int32, vHeight int32, vMipmaps int32, vFormat int32) (*Texture, *cgoAllocMap) {
	obj := *new(gTexture)
	obj.gId = vId
	obj.gWidth = vWidth
	obj.gHeight = vHeight
...
func AllocTextureCubemap(vId uint32, vWidth int32, vHeight int32, vMipmaps int32, vFormat int32) (*TextureCubemap, *cgoAllocMap) {
	obj := *new(gTextureCubemap)
	obj.gId = vId
	obj.gWidth = vWidth
	obj.gHeight = vHeight
...
func AllocRenderTexture2D(vId uint32, vTexture Texture2D, vDepth Texture2D, vDepthTexture bool) (*RenderTexture2D, *cgoAllocMap) {
	obj := *new(gRenderTexture2D)
	obj.gId = vId
	obj.gTexture = *newTexture2DRef(unsafe.Pointer(&vTexture))
	obj.gDepth = *newTexture2DRef(unsafe.Pointer(&vDepth))
...
func AllocRenderTexture(vId uint32, vTexture Texture2D, vDepth Texture2D, vDepthTexture bool) (*RenderTexture, *cgoAllocMap) {
	obj := *new(gRenderTexture)
	obj.gId = vId
	obj.gTexture = *newTexture2DRef(unsafe.Pointer(&vTexture))
	obj.gDepth = *newTexture2DRef(unsafe.Pointer(&vDepth))
...
func AllocNPatchInfo(vSourceRec Rectangle, vLeft int32, vTop int32, vRight int32, vBottom int32, vType int32) (*NPatchInfo, *cgoAllocMap) {
	obj := *new(gNPatchInfo)
	obj.gSourceRec = *newRectangleRef(unsafe.Pointer(&vSourceRec))
	obj.gLeft = vLeft
	obj.gTop = vTop
...
func AllocCharInfo(vValue int32, vOffsetX int32, vOffsetY int32, vAdvanceX int32, vImage Image) (*CharInfo, *cgoAllocMap) {
	obj := *new(gCharInfo)
	obj.gValue = vValue
	obj.gOffsetX = vOffsetX
	obj.gOffsetY = vOffsetY
...
func AllocFont(vBaseSize int32, vCharsCount int32, vTexture Texture2D, vRecs []Rectangle, vChars []CharInfo) (*Font, *cgoAllocMap) {
	obj := *new(gFont)
	obj.gBaseSize = vBaseSize
	obj.gCharsCount = vCharsCount
	obj.gTexture = *newTexture2DRef(unsafe.Pointer(&vTexture))
...
func AllocCamera3D(vPosition Vector3, vTarget Vector3, vUp Vector3, vFovy float32, vType int32) (*Camera3D, *cgoAllocMap) {
	obj := *new(gCamera3D)
	obj.gPosition = *newVector3Ref(unsafe.Pointer(&vPosition))
	obj.gTarget = *newVector3Ref(unsafe.Pointer(&vTarget))
	obj.gUp = *newVector3Ref(unsafe.Pointer(&vUp))
...
func AllocCamera(vPosition Vector3, vTarget Vector3, vUp Vector3, vFovy float32, vType int32) (*Camera, *cgoAllocMap) {
	obj := *new(gCamera)
	obj.gPosition = *newVector3Ref(unsafe.Pointer(&vPosition))
	obj.gTarget = *newVector3Ref(unsafe.Pointer(&vTarget))
	obj.gUp = *newVector3Ref(unsafe.Pointer(&vUp))
...
func AllocCamera2D(vOffset Vector2, vTarget Vector2, vRotation float32, vZoom float32) (*Camera2D, *cgoAllocMap) {
	obj := *new(gCamera2D)
	obj.gOffset = *newVector2Ref(unsafe.Pointer(&vOffset))
	obj.gTarget = *newVector2Ref(unsafe.Pointer(&vTarget))
	obj.gRotation = vRotation
...
func AllocMesh(vVertexCount int32, vTriangleCount int32, vVertices []float32, vTexcoords []float32, vTexcoords2 []float32, vNormals []float32, vTangents []float32, vColors []byte, vIndices []uint16, vAnimVertices []float32, vAnimNormals []float32, vBoneIds []int32, vBoneWeights []float32, vVaoId uint32, vVboId []uint32) (*Mesh, *cgoAllocMap) {
	obj := *new(gMesh)
	obj.gVertexCount = vVertexCount
	obj.gTriangleCount = vTriangleCount
	obj.gVertices = vVertices
...
func AllocShader(vId uint32, vLocs []int32) (*Shader, *cgoAllocMap) {
	obj := *new(gShader)
	obj.gId = vId
	obj.gLocs = vLocs
...
func AllocMaterialMap(vTexture Texture2D, vColor Color, vValue float32) (*MaterialMap, *cgoAllocMap) {
	obj := *new(gMaterialMap)
	obj.gTexture = *newTexture2DRef(unsafe.Pointer(&vTexture))
	obj.gColor = *newColorRef(unsafe.Pointer(&vColor))
	obj.gValue = vValue
...
func AllocMaterial(vShader Shader, vMaps []MaterialMap, vParams []float32) (*Material, *cgoAllocMap) {
	obj := *new(gMaterial)
	obj.gShader = *newShaderRef(unsafe.Pointer(&vShader))
...
func AllocTransform(vTranslation Vector3, vRotation Quaternion, vScale Vector3) (*Transform, *cgoAllocMap) {
	obj := *new(gTransform)
	obj.gTranslation = *newVector3Ref(unsafe.Pointer(&vTranslation))
	obj.gRotation = *newQuaternionRef(unsafe.Pointer(&vRotation))
	obj.gScale = *newVector3Ref(unsafe.Pointer(&vScale))
...
func AllocBoneInfo(vName [32]byte, vParent int32) (*BoneInfo, *cgoAllocMap) {
	obj := *new(gBoneInfo)
	obj.gName = vName
	obj.gParent = vParent
...
func AllocModel(vTransform Matrix, vMeshCount int32, vMeshes []Mesh, vMaterialCount int32, vMaterials []Material, vMeshMaterial []int32, vBoneCount int32, vBones []BoneInfo, vBindPose []Transform) (*Model, *cgoAllocMap) {
	obj := *new(gModel)
	obj.gTransform = *newMatrixRef(unsafe.Pointer(&vTransform))
	obj.gMeshCount = vMeshCount
...
func AllocModelAnimation(vBoneCount int32, vBones []BoneInfo, vFrameCount int32, vFramePoses [][]Transform) (*ModelAnimation, *cgoAllocMap) {
	obj := *new(gModelAnimation)
	obj.gBoneCount = vBoneCount
...
func AllocRay(vPosition Vector3, vDirection Vector3) (*Ray, *cgoAllocMap) {
	obj := *new(gRay)
	obj.gPosition = *newVector3Ref(unsafe.Pointer(&vPosition))
	obj.gDirection = *newVector3Ref(unsafe.Pointer(&vDirection))
...
func AllocRayHitInfo(vHit bool, vDistance float32, vPosition Vector3, vNormal Vector3) (*RayHitInfo, *cgoAllocMap) {
	obj := *new(gRayHitInfo)
	obj.gHit = vHit
	obj.gDistance = vDistance
	obj.gPosition = *newVector3Ref(unsafe.Pointer(&vPosition))
...
func AllocBoundingBox(vMin Vector3, vMax Vector3) (*BoundingBox, *cgoAllocMap) {
	obj := *new(gBoundingBox)
	obj.gMin = *newVector3Ref(unsafe.Pointer(&vMin))
	obj.gMax = *newVector3Ref(unsafe.Pointer(&vMax))
...
func AllocWave(vSampleCount uint32, vSampleRate uint32, vSampleSize uint32, vChannels uint32, vData unsafe.Pointer) (*Wave, *cgoAllocMap) {
	obj := *new(gWave)
	obj.gSampleCount = vSampleCount
	obj.gSampleRate = vSampleRate
	obj.gSampleSize = vSampleSize
...
func AllocAudioStream(vSampleRate uint32, vSampleSize uint32, vChannels uint32) (*AudioStream, *cgoAllocMap) {
	obj := *new(gAudioStream)
	obj.gSampleRate = vSampleRate
	obj.gSampleSize = vSampleSize
	obj.gChannels = vChannels
...
func AllocSound(vSampleCount uint32, vStream AudioStream) (*Sound, *cgoAllocMap) {
	obj := *new(gSound)
	obj.gSampleCount = vSampleCount
	obj.gStream = *newAudioStreamRef(unsafe.Pointer(&vStream))
...
func AllocMusic(vCtxType int32, vCtxData unsafe.Pointer, vLooping bool, vSampleCount uint32, vStream AudioStream) (*Music, *cgoAllocMap) {
	obj := *new(gMusic)
	obj.gCtxType = vCtxType
	obj.gCtxData = vCtxData
	obj.gLooping = vLooping
...
func AllocVrDeviceInfo(vHResolution int32, vVResolution int32, vHScreenSize float32, vVScreenSize float32, vVScreenCenter float32, vEyeToScreenDistance float32, vLensSeparationDistance float32, vInterpupillaryDistance float32, vLensDistortionValues [4]float32, vChromaAbCorrection [4]float32) (*VrDeviceInfo, *cgoAllocMap) {
	obj := *new(gVrDeviceInfo)
	obj.gHResolution = vHResolution
	obj.gVResolution = vVResolution
	obj.gHScreenSize = vHScreenSize
...
func AllocMultiText(vText []string) (*MultiText, *cgoAllocMap) {
	obj := *new(gMultiText)
	obj.gText = vText
