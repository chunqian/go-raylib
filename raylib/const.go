...
const (
	// C_FOR_GO as defined in go-raylib/<predefine>:24
	C_FOR_GO = 1
	// C_FOR_GO_DISABLE as defined in go-raylib/<predefine>:25
	C_FOR_GO_DISABLE = 1
	// RLAPI as defined in src/raylib.h:89
	...
	RAD2DEG = (180.0 / PI)
	// FormatText as defined in src/raylib.h:156
	FormatText = 0
	// SubText as defined in src/raylib.h:157
	SubText = 0
	// ShowWindow as defined in src/raylib.h:158
	ShowWindow = 0
	// LoadText as defined in src/raylib.h:159
	LoadText = 0
	// LOC_MAP_DIFFUSE as defined in src/raylib.h:709
	LOC_MAP_DIFFUSE = 0
	// LOC_MAP_SPECULAR as defined in src/raylib.h:710
	LOC_MAP_SPECULAR = 0
	// MAP_DIFFUSE as defined in src/raylib.h:740
	MAP_DIFFUSE = 0
	// MAP_SPECULAR as defined in src/raylib.h:741
	MAP_SPECULAR = 0
...
// ConfigFlag as declared in src/raylib.h:479
type ConfigFlag int32

// ConfigFlag enumeration from src/raylib.h:479
const (
...
// KeyboardKey as declared in src/raylib.h:605
type KeyboardKey int32

// KeyboardKey enumeration from src/raylib.h:605
const (
...
// AndroidButton as declared in src/raylib.h:613
type AndroidButton int32

// AndroidButton enumeration from src/raylib.h:613
const (
...
// MouseButton as declared in src/raylib.h:620
type MouseButton int32

// MouseButton enumeration from src/raylib.h:620
const (
...
// GamepadNumber as declared in src/raylib.h:628
type GamepadNumber int32

// GamepadNumber enumeration from src/raylib.h:628
const (
...
// GamepadButton as declared in src/raylib.h:664
type GamepadButton int32

// GamepadButton enumeration from src/raylib.h:664
const (
...
// GamepadAxis as declared in src/raylib.h:678
type GamepadAxis int32

// GamepadAxis enumeration from src/raylib.h:678
const (
...
// ShaderLocationIndex as declared in src/raylib.h:707
type ShaderLocationIndex int32

// ShaderLocationIndex enumeration from src/raylib.h:707
const (
...
// ShaderUniformDataType as declared in src/raylib.h:723
type ShaderUniformDataType int32

// ShaderUniformDataType enumeration from src/raylib.h:723
const (
...
// MaterialMapType as declared in src/raylib.h:738
type MaterialMapType int32

// MaterialMapType enumeration from src/raylib.h:738
const (
...
// PixelFormat as declared in src/raylib.h:767
type PixelFormat int32

// PixelFormat enumeration from src/raylib.h:767
const (
...
// TextureFilterMode as declared in src/raylib.h:779
type TextureFilterMode int32

// TextureFilterMode enumeration from src/raylib.h:779
const (
...
// CubemapLayoutType as declared in src/raylib.h:789
type CubemapLayoutType int32

// CubemapLayoutType enumeration from src/raylib.h:789
const (
...
// TextureWrapMode as declared in src/raylib.h:797
type TextureWrapMode int32

// TextureWrapMode enumeration from src/raylib.h:797
const (
...
// BlendMode as declared in src/raylib.h:812
type BlendMode int32

// BlendMode enumeration from src/raylib.h:812
const (
...
// GestureType as declared in src/raylib.h:828
type GestureType int32

// GestureType enumeration from src/raylib.h:828
const (
...
// CameraMode as declared in src/raylib.h:837
type CameraMode int32

// CameraMode enumeration from src/raylib.h:837
const (
...
// CameraType as declared in src/raylib.h:843
type CameraType int32

// CameraType enumeration from src/raylib.h:843
const (
	CAMERA_PERSPECTIVE  CameraType = iota
	CAMERA_ORTHOGRAPHIC CameraType = 1
)

// NPatchType as declared in src/raylib.h:850
type NPatchType int32

// NPatchType enumeration from src/raylib.h:850
const (
