...
func CreatePhysicsManifold(a *PhysicsBodyData, b *PhysicsBodyData) *PhysicsManifoldData {
	ca, _ := (*C.PhysicsBody)(unsafe.Pointer(a)), cgoAllocsUnknown
	cb, _ := (*C.PhysicsBody)(unsafe.Pointer(b)), cgoAllocsUnknown
...
func DestroyPhysicsManifold(manifold *PhysicsManifoldData) {
	cmanifold, _ := (*C.PhysicsManifold)(unsafe.Pointer(manifold)), cgoAllocsUnknown
