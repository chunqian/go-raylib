...
// Auto free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func clearMatrix2x2Memory(x *Matrix2x2) {
...
// Auto free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func clearPolygonDataMemory(x *PolygonData) {
...
// Auto free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func clearPhysicsShapeMemory(x *PhysicsShape) {
...
func (s *PhysicsShape) Transform() *Matrix2x2 {
	if s.ref() == nil {
		s.PassRef()
	}
	var ret *Matrix2x2
...
func (s *PhysicsShape) VertexData() *PolygonData {
	if s.ref() == nil {
		s.PassRef()
	}
	var ret *PolygonData
...
// Auto free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func clearPhysicsBodyDataMemory(x *PhysicsBodyData) {
...
func (s *PhysicsBodyData) Position() *Vector2 {
	if s.ref() == nil {
		s.PassRef()
	}
	var ret *Vector2
...
func (s *PhysicsBodyData) Velocity() *Vector2 {
	if s.ref() == nil {
		s.PassRef()
	}
	var ret *Vector2
...
func (s *PhysicsBodyData) Force() *Vector2 {
	if s.ref() == nil {
		s.PassRef()
	}
	var ret *Vector2
...
func (s *PhysicsBodyData) Shape() *PhysicsShape {
	if s.ref() == nil {
		s.PassRef()
	}
...
// Auto free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func clearPhysicsManifoldDataMemory(x *PhysicsManifoldData) {
...
func (s *PhysicsManifoldData) Normal() *Vector2 {
	if s.ref() == nil {
		s.PassRef()
	}
	var ret *Vector2
