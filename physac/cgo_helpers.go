...
func NewMatrix2x2(m000 float32, m010 float32, m100 float32, m110 float32) Matrix2x2 {
	obj := *new(gMatrix2x2)
	obj.gM00 = m000
	obj.gM01 = m010
	obj.gM10 = m100
...
func AllocMatrix2x2(m000 float32, m010 float32, m100 float32, m110 float32) (*Matrix2x2, *cgoAllocMap) {
	obj := *new(gMatrix2x2)
	obj.gM00 = m000
	obj.gM01 = m010
	obj.gM10 = m100
...
// GC is register for garbage collection.
func (x *Matrix2x2) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewPolygonData(vertexCount0 uint32, positions0 [24]Vector2, normals0 [24]Vector2) PolygonData {
	obj := *new(gPolygonData)
	obj.gVertexCount = vertexCount0

	var positions1 [24]gVector2
	for i0 := range positions0 {
		p0 := *newVector2Ref(unsafe.Pointer(&positions0[i0]))
		positions1[i0] = p0
	}
	obj.gPositions = positions1

	var normals1 [24]gVector2
	for i0 := range normals0 {
		p0 := *newVector2Ref(unsafe.Pointer(&normals0[i0]))
		normals1[i0] = p0
	}
	obj.gNormals = normals1
...
func AllocPolygonData(vertexCount0 uint32, positions0 [24]Vector2, normals0 [24]Vector2) (*PolygonData, *cgoAllocMap) {
	obj := *new(gPolygonData)
	obj.gVertexCount = vertexCount0
...
// GC is register for garbage collection.
func (x *PolygonData) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewPhysicsShape(type0 PhysicsShapeType, body0 []PhysicsBodyData, radius0 float32, transform0 Matrix2x2, vertexData0 PolygonData) PhysicsShape {
	obj := *new(gPhysicsShape)
	obj.gType = type0

	var body1 []gPhysicsBodyData
	for i0 := range body0 {
		p0 := *newPhysicsBodyDataRef(unsafe.Pointer(&body0[i0]))
		body1 = append(body1, p0)
	}
	obj.gBody = body1
	obj.gRadius = radius0
	obj.gTransform = *newMatrix2x2Ref(unsafe.Pointer(&transform0))
	obj.gVertexData = *newPolygonDataRef(unsafe.Pointer(&vertexData0))
...
func AllocPhysicsShape(type0 PhysicsShapeType, body0 []PhysicsBodyData, radius0 float32, transform0 Matrix2x2, vertexData0 PolygonData) (*PhysicsShape, *cgoAllocMap) {
	obj := *new(gPhysicsShape)
	obj.gType = type0
...
// GC is register for garbage collection.
func (x *PhysicsShape) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewPhysicsBodyData(id0 uint32, enabled0 bool, position0 Vector2, velocity0 Vector2, force0 Vector2, angularVelocity0 float32, torque0 float32, orient0 float32, inertia0 float32, inverseInertia0 float32, mass0 float32, inverseMass0 float32, staticFriction0 float32, dynamicFriction0 float32, restitution0 float32, useGravity0 bool, isGrounded0 bool, freezeOrient0 bool, shape0 PhysicsShape) PhysicsBodyData {
	obj := *new(gPhysicsBodyData)
	obj.gId = id0
	obj.gEnabled = enabled0
	obj.gPosition = *newVector2Ref(unsafe.Pointer(&position0))
	obj.gVelocity = *newVector2Ref(unsafe.Pointer(&velocity0))
	obj.gForce = *newVector2Ref(unsafe.Pointer(&force0))
	obj.gAngularVelocity = angularVelocity0
	obj.gTorque = torque0
	obj.gOrient = orient0
	obj.gInertia = inertia0
	obj.gInverseInertia = inverseInertia0
	obj.gMass = mass0
	obj.gInverseMass = inverseMass0
	obj.gStaticFriction = staticFriction0
	obj.gDynamicFriction = dynamicFriction0
	obj.gRestitution = restitution0
	obj.gUseGravity = useGravity0
	obj.gIsGrounded = isGrounded0
	obj.gFreezeOrient = freezeOrient0
	obj.gShape = *newPhysicsShapeRef(unsafe.Pointer(&shape0))
...
func AllocPhysicsBodyData(id0 uint32, enabled0 bool, position0 Vector2, velocity0 Vector2, force0 Vector2, angularVelocity0 float32, torque0 float32, orient0 float32, inertia0 float32, inverseInertia0 float32, mass0 float32, inverseMass0 float32, staticFriction0 float32, dynamicFriction0 float32, restitution0 float32, useGravity0 bool, isGrounded0 bool, freezeOrient0 bool, shape0 PhysicsShape) (*PhysicsBodyData, *cgoAllocMap) {
	obj := *new(gPhysicsBodyData)
	obj.gId = id0
	obj.gEnabled = enabled0
	obj.gPosition = *newVector2Ref(unsafe.Pointer(&position0))
...
// GC is register for garbage collection.
func (x *PhysicsBodyData) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
...
func NewPhysicsManifoldData(id0 uint32, bodyA0 []PhysicsBodyData, bodyB0 []PhysicsBodyData, penetration0 float32, normal0 Vector2, contacts0 [2]Vector2, contactsCount0 uint32, restitution0 float32, dynamicFriction0 float32, staticFriction0 float32) PhysicsManifoldData {
	obj := *new(gPhysicsManifoldData)
	obj.gId = id0

	var bodyA1 []gPhysicsBodyData
	for i0 := range bodyA0 {
		p0 := *newPhysicsBodyDataRef(unsafe.Pointer(&bodyA0[i0]))
		bodyA1 = append(bodyA1, p0)
	}
	obj.gBodyA = bodyA1

	var bodyB1 []gPhysicsBodyData
	for i0 := range bodyB0 {
		p0 := *newPhysicsBodyDataRef(unsafe.Pointer(&bodyB0[i0]))
		bodyB1 = append(bodyB1, p0)
	}
	obj.gBodyB = bodyB1
	obj.gPenetration = penetration0
	obj.gNormal = *newVector2Ref(unsafe.Pointer(&normal0))

	var contacts1 [2]gVector2
	for i0 := range contacts0 {
		p0 := *newVector2Ref(unsafe.Pointer(&contacts0[i0]))
		contacts1[i0] = p0
	}
	obj.gContacts = contacts1
	obj.gContactsCount = contactsCount0
	obj.gRestitution = restitution0
	obj.gDynamicFriction = dynamicFriction0
	obj.gStaticFriction = staticFriction0
...
func AllocPhysicsManifoldData(id0 uint32, bodyA0 []PhysicsBodyData, bodyB0 []PhysicsBodyData, penetration0 float32, normal0 Vector2, contacts0 [2]Vector2, contactsCount0 uint32, restitution0 float32, dynamicFriction0 float32, staticFriction0 float32) (*PhysicsManifoldData, *cgoAllocMap) {
	obj := *new(gPhysicsManifoldData)
	obj.gId = id0
...
// GC is register for garbage collection.
func (x *PhysicsManifoldData) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
