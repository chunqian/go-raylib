...
// Self mapping struct value.
func (x *Matrix2x2) Self() *matrix2x2 {
	if x.refb92f06e6 != nil {
...
// Self mapping struct value.
func (x *PolygonData) Self() *polygonData {
	if x.ref87a94eb7 != nil {
...
// Self mapping struct value.
func (x *PhysicsShape) Self() *physicsShape {
	if x.ref4c540f1a != nil {
...
// Self mapping struct value.
func (x *PhysicsBodyData) Self() *physicsBodyData {
	if x.refd780e53 != nil {
...
// Self mapping struct value.
func (x *PhysicsManifoldData) Self() *physicsManifoldData {
	if x.ref10b92967 != nil {
