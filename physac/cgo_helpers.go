...
// Offset reads Go data structure out from plain C format.
func (x *Matrix2x2) Offset(index int32) *Matrix2x2 {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *PolygonData) Offset(index int32) *PolygonData {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *PhysicsShape) Offset(index int32) *PhysicsShape {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *PhysicsBodyData) Offset(index int32) *PhysicsBodyData {
	ptr0, _ := x.PassRef()
...
// Offset reads Go data structure out from plain C format.
func (x *PhysicsManifoldData) Offset(index int32) *PhysicsManifoldData {
	ptr0, _ := x.PassRef()
