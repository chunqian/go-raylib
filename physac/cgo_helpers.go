...
// Auto free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func clearMatrix2x2Memory(x *gMatrix2x2) {
...
// gc is register for garbage collection.
func (x *gMatrix2x2) gc() {
	a := x.allocsb92f06e6.(*cgoAllocMap)
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
		runtime.SetFinalizer(x, clearMatrix2x2Memory)
	}
}
...
func NewMatrix2x2(vM00 float32, vM01 float32, vM10 float32, vM11 float32) Matrix2x2 {
	...
	obj.gM11 = vM11
	ret := obj.convert()
	return *(*Matrix2x2)(unsafe.Pointer(ret))
}
...
// Auto free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func clearPolygonDataMemory(x *gPolygonData) {
...
// gc is register for garbage collection.
func (x *gPolygonData) gc() {
	a := x.allocs87a94eb7.(*cgoAllocMap)
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
		runtime.SetFinalizer(x, clearPolygonDataMemory)
	}
}
...
func NewPolygonData(vVertexCount uint32, vPositions [24]Vector2, vNormals [24]Vector2) PolygonData {
	...
	ret := obj.convert()
	return *(*PolygonData)(unsafe.Pointer(ret))
}
...
// Auto free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func clearPhysicsShapeMemory(x *gPhysicsShape) {
...
// gc is register for garbage collection.
func (x *gPhysicsShape) gc() {
	a := x.allocs4c540f1a.(*cgoAllocMap)
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
		runtime.SetFinalizer(x, clearPhysicsShapeMemory)
	}
}
...
func NewPhysicsShape(vType PhysicsShapeType, vBody []PhysicsBodyData, vRadius float32, vTransform Matrix2x2, vVertexData PolygonData) PhysicsShape {
	...
	ret := obj.convert()
	return *(*PhysicsShape)(unsafe.Pointer(ret))
}
...
// Auto free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func clearPhysicsBodyDataMemory(x *gPhysicsBodyData) {
...
// gc is register for garbage collection.
func (x *gPhysicsBodyData) gc() {
	a := x.allocsd780e53.(*cgoAllocMap)
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
		runtime.SetFinalizer(x, clearPhysicsBodyDataMemory)
	}
}
...
func NewPhysicsBodyData(vId uint32, vEnabled bool, vPosition Vector2, vVelocity Vector2, vForce Vector2, vAngularVelocity float32, vTorque float32, vOrient float32, vInertia float32, vInverseInertia float32, vMass float32, vInverseMass float32, vStaticFriction float32, vDynamicFriction float32, vRestitution float32, vUseGravity bool, vIsGrounded bool, vFreezeOrient bool, vShape PhysicsShape) PhysicsBodyData {
	...
	ret := obj.convert()
	return *(*PhysicsBodyData)(unsafe.Pointer(ret))
}
...
// Auto free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func clearPhysicsManifoldDataMemory(x *gPhysicsManifoldData) {
...
// gc is register for garbage collection.
func (x *gPhysicsManifoldData) gc() {
	a := x.allocs10b92967.(*cgoAllocMap)
	if len(a.m) > 0 {
		for ptr := range a.m {
			fmt.Printf("INFO: MEMORY: [PTR %p] GC register\n", ptr)
		}
		runtime.SetFinalizer(x, clearPhysicsManifoldDataMemory)
	}
}
...
func NewPhysicsManifoldData(vId uint32, vBodyA []PhysicsBodyData, vBodyB []PhysicsBodyData, vPenetration float32, vNormal Vector2, vContacts [2]Vector2, vContactsCount uint32, vRestitution float32, vDynamicFriction float32, vStaticFriction float32) PhysicsManifoldData {
	...
	obj.gStaticFriction = vStaticFriction
	ret := obj.convert()
	return *(*PhysicsManifoldData)(unsafe.Pointer(ret))
}
