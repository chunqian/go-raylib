...
// WARNING: This file has automatically been generated on Thu, 10 Sep 2020 10:51:02 CST.
...
func NewMatrix2x2(vM00 float32, vM01 float32, vM10 float32, vM11 float32) Matrix2x2 {
	obj := *new(gMatrix2x2)
	obj.gM00 = vM00
	obj.gM01 = vM01
	obj.gM10 = vM10
...
func AllocMatrix2x2(vM00 float32, vM01 float32, vM10 float32, vM11 float32) (*Matrix2x2, *cgoAllocMap) {
	obj := *new(gMatrix2x2)
	obj.gM00 = vM00
	obj.gM01 = vM01
	obj.gM10 = vM10
...
func NewPolygonData(vVertexCount uint32, vPositions [24]Vector2, vNormals [24]Vector2) PolygonData {
	obj := *new(gPolygonData)
	obj.gVertexCount = vVertexCount

	var positionsT [24]gVector2
	for i0 := range vPositions {
		p0 := *newVector2Ref(unsafe.Pointer(&vPositions[i0]))
		positionsT[i0] = p0
	}
	obj.gPositions = positionsT

	var normalsT [24]gVector2
	for i0 := range vNormals {
		p0 := *newVector2Ref(unsafe.Pointer(&vNormals[i0]))
		normalsT[i0] = p0
	}
	obj.gNormals = normalsT
...
func AllocPolygonData(vVertexCount uint32, vPositions [24]Vector2, vNormals [24]Vector2) (*PolygonData, *cgoAllocMap) {
	obj := *new(gPolygonData)
	obj.gVertexCount = vVertexCount
...
func NewPhysicsShape(vType PhysicsShapeType, vBody []PhysicsBodyData, vRadius float32, vTransform Matrix2x2, vVertexData PolygonData) PhysicsShape {
	obj := *new(gPhysicsShape)
	obj.gType = vType

	var bodyT []gPhysicsBodyData
	for i0 := range vBody {
		p0 := *newPhysicsBodyDataRef(unsafe.Pointer(&vBody[i0]))
		bodyT = append(bodyT, p0)
	}
	obj.gBody = bodyT
	obj.gRadius = vRadius
	obj.gTransform = *newMatrix2x2Ref(unsafe.Pointer(&vTransform))
	obj.gVertexData = *newPolygonDataRef(unsafe.Pointer(&vVertexData))
...
func AllocPhysicsShape(vType PhysicsShapeType, vBody []PhysicsBodyData, vRadius float32, vTransform Matrix2x2, vVertexData PolygonData) (*PhysicsShape, *cgoAllocMap) {
	obj := *new(gPhysicsShape)
	obj.gType = vType
...
func NewPhysicsBodyData(vId uint32, vEnabled bool, vPosition Vector2, vVelocity Vector2, vForce Vector2, vAngularVelocity float32, vTorque float32, vOrient float32, vInertia float32, vInverseInertia float32, vMass float32, vInverseMass float32, vStaticFriction float32, vDynamicFriction float32, vRestitution float32, vUseGravity bool, vIsGrounded bool, vFreezeOrient bool, vShape PhysicsShape) PhysicsBodyData {
	obj := *new(gPhysicsBodyData)
	obj.gId = vId
	obj.gEnabled = vEnabled
	obj.gPosition = *newVector2Ref(unsafe.Pointer(&vPosition))
	obj.gVelocity = *newVector2Ref(unsafe.Pointer(&vVelocity))
	obj.gForce = *newVector2Ref(unsafe.Pointer(&vForce))
	obj.gAngularVelocity = vAngularVelocity
	obj.gTorque = vTorque
	obj.gOrient = vOrient
	obj.gInertia = vInertia
	obj.gInverseInertia = vInverseInertia
	obj.gMass = vMass
	obj.gInverseMass = vInverseMass
	obj.gStaticFriction = vStaticFriction
	obj.gDynamicFriction = vDynamicFriction
	obj.gRestitution = vRestitution
	obj.gUseGravity = vUseGravity
	obj.gIsGrounded = vIsGrounded
	obj.gFreezeOrient = vFreezeOrient
	obj.gShape = *newPhysicsShapeRef(unsafe.Pointer(&vShape))
...
func AllocPhysicsBodyData(vId uint32, vEnabled bool, vPosition Vector2, vVelocity Vector2, vForce Vector2, vAngularVelocity float32, vTorque float32, vOrient float32, vInertia float32, vInverseInertia float32, vMass float32, vInverseMass float32, vStaticFriction float32, vDynamicFriction float32, vRestitution float32, vUseGravity bool, vIsGrounded bool, vFreezeOrient bool, vShape PhysicsShape) (*PhysicsBodyData, *cgoAllocMap) {
	obj := *new(gPhysicsBodyData)
	obj.gId = vId
	obj.gEnabled = vEnabled
	obj.gPosition = *newVector2Ref(unsafe.Pointer(&vPosition))
...
func NewPhysicsManifoldData(vId uint32, vBodyA []PhysicsBodyData, vBodyB []PhysicsBodyData, vPenetration float32, vNormal Vector2, vContacts [2]Vector2, vContactsCount uint32, vRestitution float32, vDynamicFriction float32, vStaticFriction float32) PhysicsManifoldData {
	obj := *new(gPhysicsManifoldData)
	obj.gId = vId

	var bodyAT []gPhysicsBodyData
	for i0 := range vBodyA {
		p0 := *newPhysicsBodyDataRef(unsafe.Pointer(&vBodyA[i0]))
		bodyAT = append(bodyAT, p0)
	}
	obj.gBodyA = bodyAT

	var bodyBT []gPhysicsBodyData
	for i0 := range vBodyB {
		p0 := *newPhysicsBodyDataRef(unsafe.Pointer(&vBodyB[i0]))
		bodyBT = append(bodyBT, p0)
	}
	obj.gBodyB = bodyBT
	obj.gPenetration = vPenetration
	obj.gNormal = *newVector2Ref(unsafe.Pointer(&vNormal))

	var contactsT [2]gVector2
	for i0 := range vContacts {
		p0 := *newVector2Ref(unsafe.Pointer(&vContacts[i0]))
		contactsT[i0] = p0
	}
	obj.gContacts = contactsT
	obj.gContactsCount = vContactsCount
	obj.gRestitution = vRestitution
	obj.gDynamicFriction = vDynamicFriction
	obj.gStaticFriction = vStaticFriction
...
func AllocPhysicsManifoldData(vId uint32, vBodyA []PhysicsBodyData, vBodyB []PhysicsBodyData, vPenetration float32, vNormal Vector2, vContacts [2]Vector2, vContactsCount uint32, vRestitution float32, vDynamicFriction float32, vStaticFriction float32) (*PhysicsManifoldData, *cgoAllocMap) {
	obj := *new(gPhysicsManifoldData)
	obj.gId = vId
