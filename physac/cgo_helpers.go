...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gMatrix2x2) ref() *C.Matrix2x2 {
	if x == nil {
		return nil
	}
...
func NewPolygonData(gVertexCount uint32, gPositions [24]Vector2, gNormals [24]Vector2) PolygonData {
	...
	obj.gPositions = *newVector2Ref(unsafe.Pointer(&gPositions))
	obj.gNormals = *newVector2Ref(unsafe.Pointer(&gNormals))
	ret := obj.convert()
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gPolygonData) ref() *C.PolygonData {
	if x == nil {
		return nil
	}
...
func (s *PolygonData) Positions(positionsIndex int32) *Vector2 {
	var ret *Vector2
...
func (s *PolygonData) Normals(normalsIndex int32) *Vector2 {
	var ret *Vector2
	// c struct pointer offset
	ptr0 := &s.normals
...
func NewPhysicsShape(gType PhysicsShapeType, gBody []gPhysicsBodyData, gRadius float32, gTransform Matrix2x2, gVertexData PolygonData) PhysicsShape {
	obj := *new(gPhysicsShape)
	obj.gType = gType
	obj.gBody = gBody
	obj.gRadius = gRadius
	obj.gTransform = *newMatrix2x2Ref(unsafe.Pointer(&gTransform))
	obj.gVertexData = *newPolygonDataRef(unsafe.Pointer(&gVertexData))
	ret := obj.convert()
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gPhysicsShape) ref() *C.PhysicsShape {
	if x == nil {
		return nil
	}
...
// Type returns a reference to C object within a struct

// Body returns a reference to C object within a struct
func (s *PhysicsShape) Body(bodyIndex int32) *PhysicsBodyData {
...
// VertexData returns a reference to C object within a struct
...
func NewPhysicsBodyData(gId uint32, gEnabled bool, gPosition Vector2, gVelocity Vector2, gForce Vector2, gAngularVelocity float32, gTorque float32, gOrient float32, gInertia float32, gInverseInertia float32, gMass float32, gInverseMass float32, gStaticFriction float32, gDynamicFriction float32, gRestitution float32, gUseGravity bool, gIsGrounded bool, gFreezeOrient bool, gShape PhysicsShape) PhysicsBodyData {
	...
	obj.gPosition = *newVector2Ref(unsafe.Pointer(&gPosition))
	obj.gVelocity = *newVector2Ref(unsafe.Pointer(&gVelocity))
	obj.gForce = *newVector2Ref(unsafe.Pointer(&gForce))
	...
	obj.gShape = *newPhysicsShapeRef(unsafe.Pointer(&gShape))
	ret := obj.convert()
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gPhysicsBodyData) ref() *C.PhysicsBodyData {
	if x == nil {
		return nil
	}
	return x.refd780e53
...
// Velocity returns a reference to C object within a struct

// Force returns a reference to C object within a struct

// Shape returns a reference to C object within a struct
...
func NewPhysicsManifoldData(gId uint32, gBodyA []gPhysicsBodyData, gBodyB []gPhysicsBodyData, gPenetration float32, gNormal Vector2, gContacts [2]Vector2, gContactsCount uint32, gRestitution float32, gDynamicFriction float32, gStaticFriction float32) PhysicsManifoldData {
	obj := *new(gPhysicsManifoldData)
	obj.gId = gId
	obj.gBodyA = gBodyA
	obj.gBodyB = gBodyB
	obj.gPenetration = gPenetration
	obj.gNormal = *newVector2Ref(unsafe.Pointer(&gNormal))
	obj.gContacts = *newVector2Ref(unsafe.Pointer(&gContacts))
...
// ref returns the underlying reference to C object or nil if struct is nil.
func (x *gPhysicsManifoldData) ref() *C.PhysicsManifoldData {
	if x == nil {
		return nil
	}
...
func (s *PhysicsManifoldData) BodyA(bodyAIndex int32) *PhysicsBodyData {
	var ret *PhysicsBodyData
	// c struct pointer offset
	ptr0 := s.bodyA
...
func (s *PhysicsManifoldData) BodyB(bodyBIndex int32) *PhysicsBodyData {
	var ret *PhysicsBodyData
	// c struct pointer offset
	ptr0 := s.bodyB
...
func (s *PhysicsManifoldData) Contacts(contactsIndex int32) *Vector2 {
	var ret *Vector2
	// c struct pointer offset
	ptr0 := &s.contacts
