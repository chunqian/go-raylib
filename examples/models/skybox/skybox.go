...
func main() {
	...
	defer func() {
		rl.UnloadTexture(skybox.Materialser(0).Mapser(int32(rl.MAP_CUBEMAP)).Texture)
	...
	skybox.Materialser(0).Mapser(int32(rl.MAP_CUBEMAP)).Texture = rl.GenTextureCubemap(shdrCubemap, texHDR, 512)
