...
func clearGuiStylePropMemory(x *gGuiStyleProp) {
...
func NewGuiStyleProp(gControlId uint16, gPropertyId uint16, gPropertyValue int32) GuiStyleProp {
	...
	ret := obj.convert()
	return *(*GuiStyleProp)(unsafe.Pointer(ret))
}
...
func (x *gGuiStyleProp) ref() *C.GuiStyleProp {
	if x == nil {
		return nil
	}
...
func NewFont(gBaseSize int32, gCharsCount int32, gTexture Texture2D, gRecs []gRectangle) Font {
	obj := *new(gFont)
