...
func NewGuiStyleProp(vControlId uint16, vPropertyId uint16, vPropertyValue int32) GuiStyleProp {
	obj := *new(gGuiStyleProp)
	obj.gControlId = vControlId
	obj.gPropertyId = vPropertyId
	obj.gPropertyValue = vPropertyValue
...
func AllocGuiStyleProp(vControlId uint16, vPropertyId uint16, vPropertyValue int32) (*GuiStyleProp, *cgoAllocMap) {
	obj := *new(gGuiStyleProp)
	obj.gControlId = vControlId
	obj.gPropertyId = vPropertyId
	obj.gPropertyValue = vPropertyValue
