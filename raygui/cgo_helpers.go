...
// GetControlId returns a reference to C object within a struct
func (s *GuiStyleProp) GetControlId() *uint16 {
	if s.Ref() == nil {
		s.PassRef()
	}
	var ret *uint16
	ret = (*uint16)(unsafe.Pointer(&s.Ref().controlId))
	return ret
}

// SetControlId update C object and binding struct
func (s *GuiStyleProp) SetControlId(controlId uint16) *GuiStyleProp {
	if s.Ref() == nil {
		s.PassRef()
	}
	s.Ref().controlId = (C.ushort)(controlId)
	return s
}

// GetPropertyId returns a reference to C object within a struct
func (s *GuiStyleProp) GetPropertyId() *uint16 {
	if s.Ref() == nil {
		s.PassRef()
	}
	var ret *uint16
	ret = (*uint16)(unsafe.Pointer(&s.Ref().propertyId))
	return ret
}

// SetPropertyId update C object and binding struct
func (s *GuiStyleProp) SetPropertyId(propertyId uint16) *GuiStyleProp {
	if s.Ref() == nil {
		s.PassRef()
	}
	s.Ref().propertyId = (C.ushort)(propertyId)
	return s
}

// GetPropertyValue returns a reference to C object within a struct
func (s *GuiStyleProp) GetPropertyValue() *int32 {
	if s.Ref() == nil {
		s.PassRef()
	}
	var ret *int32
	ret = (*int32)(unsafe.Pointer(&s.Ref().propertyValue))
	return ret
}

// SetPropertyValue update C object and binding struct
func (s *GuiStyleProp) SetPropertyValue(propertyValue int32) *GuiStyleProp {
	if s.Ref() == nil {
		s.PassRef()
	}
	s.Ref().propertyValue = (C.int)(propertyValue)
	return s
}
