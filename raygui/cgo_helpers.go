...
func NewGuiStyleProp(controlId0 uint16, propertyId0 uint16, propertyValue0 int32) GuiStyleProp {
	obj := *new(gGuiStyleProp)
	obj.gControlId = controlId0
	obj.gPropertyId = propertyId0
	obj.gPropertyValue = propertyValue0
...
func AllocGuiStyleProp(controlId0 uint16, propertyId0 uint16, propertyValue0 int32) (*GuiStyleProp, *cgoAllocMap) {
	obj := *new(gGuiStyleProp)
	obj.gControlId = controlId0
	obj.gPropertyId = propertyId0
	obj.gPropertyValue = propertyValue0
...
func (x *GuiStyleProp) GC(a *cgoAllocMap) {
	if len(a.m) > 0 {
		for ptr := range a.m {
